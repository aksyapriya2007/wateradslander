...
const WORKFLOW_STEPS = [
 ...
 icon: Megaphone,
 color: "bg-[#EDEDFF] text-[#3333FF] border-[#BBBBFF]",
 },
 {
 step: "02",
 ...
 icon: BarChart2,
 color: "bg-[#EDEDFF] text-[#3333FF] border-[#AAAAFF]",
 },
]
...
export function WorkflowSection() {
 ...
 <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#DDDEFF]/80 border border-[#AAAAFF]/80 text-[#2222CC] text-xs font-bold tracking-wider uppercase">
 <Sparkles className="w-3.5 h-3.5 text-[#3333FF]" />
 ...
 <div className="absolute top-1/2 left-0 w-3.5 h-3.5 rounded-full bg-[#3333FF] border-2 border-white shadow-lg shadow-[#3333FF]/80 -translate-y-1/2 pointer-events-none animate-travel-particle z-20" />
 ...
 <div
 key={index}
 className="bg-wa-bg -hover/80 hover:border-[#3333FF]/80 rounded-2xl p-5 shadow-sm hover:shadow-xl hover:shadow-[#3333FF]/5 transition-all duration-300 hover:-translate-y-1 group flex flex-col justify-between min-h-[220px]"
 >
 <div className="flex items-center justify-between">
 <span className="text-xs font-extrabold text-wa-text-muted opacity-80 tracking-wider">
 {item.step}
 </span>
 ...
 <h3 className="text-base font-bold text-[#0B1B33] group-hover:text-[#3333FF] transition-colors">
 {item.title}
 </h3>
 <p className="text-xs text-wa-text-muted opacity-90 font-medium leading-relaxed">
 {item.desc}
 </p>
 </div>
 </div>
 ...
 <div className="absolute left-[8px] top-0 w-3.5 h-3.5 rounded-full bg-[#3333FF] border-2 border-white shadow-lg shadow-[#3333FF]/80 pointer-events-none animate-travel-particle-v z-20" />
 ...
 <div
 key={index}
 className="relative bg-wa-bg -hover/80 rounded-2xl p-5 shadow-sm flex items-start gap-4"
 >
 ...
 <span className="text-xs font-bold text-[#3333FF]">{item.step}.</span>
 <h3 className="text-base font-bold text-[#0B1B33]">{item.title}</h3>
 </div>
 <p className="text-xs text-wa-text-muted opacity-90 font-medium">{item.desc}</p>
 </div>
 </div>
 )
 })}
