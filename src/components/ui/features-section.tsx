...
const FEATURES = [
  ...
  },
  {
    ...
    iconType: "refresh",
    accent: "bg-cyan-50 text-cyan-700 border-cyan-300",
  },
]

export function FeaturesSection() {
  return (
    <section id="features" className="relative z-10 py-20 px-6 md:px-12 max-w-7xl mx-auto border-t border-slate-200/70">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {FEATURES.map((item, idx) => (
          ...
          >
            ...
            <h3 className="text-xl font-bold text-[#0B1B33] mb-2 group-hover:text-cyan-600 transition-colors">
              {item.title}
            </h3>
