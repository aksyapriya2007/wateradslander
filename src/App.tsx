...
export default function App() {
 ...
 <div className="w-14 h-14 rounded-full bg-wa-card flex items-center justify-center text-wa-text-muted -hover">
 ...
 <p className="text-sm font-medium text-wa-text-muted leading-relaxed">
 ...
 <p className="text-base font-medium text-wa-text-muted leading-relaxed">
 ...
 animate={{ rotate: [0, 8, 0, -8, 0], scale: [1, 1.05, 1], x: [0, -10, 0] }}
 transition={{ duration: 12, repeat: Infinity, ease: 'easeInOut' }}
 >
 <Building2 className="w-[400px] h-[400px] text-[#3333FF] opacity-[0.04] group-hover:opacity-[0.09] transition-opacity duration-700" />
 </motion.div>
 </motion.div>

 {/* Card 2: Printing Presses (Dark) */}
 <motion.div 
 initial={{ opacity: 0, y: 40, filter: "blur(8px)", rotateX: 5 }}
 whileInView={{ opacity: 1, y: 0, filter: "blur(0px)", rotateX: 0 }}
 viewport={{ once: true, amount: 0.2 }}
 ...
 <p className="text-base font-medium text-wa-text-muted opacity-60 leading-relaxed">
 ...
 >
 <Droplets className="w-20 h-20 text-[#3333FF]/10" />
 </motion.div>
 </motion.div>
 ...
 >
 <Truck className="w-[400px] h-[400px] text-[#3333FF] opacity-[0.04] group-hover:opacity-[0.09] transition-opacity duration-700" />
 </motion.div>
 </motion.div>
