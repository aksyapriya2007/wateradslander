      ...
      <section className="relative z-10 py-32 px-6 max-w-[1400px] mx-auto bg-white border-t border-slate-100">
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
          ...
          >
            ...
            <h2 className="text-5xl md:text-[72px] font-black tracking-tighter leading-[0.9] text-black uppercase mb-16">
              HAVE SOME QUESTIONS?
            </h2>
            
            <div className="mt-auto hidden lg:block">
              <h4 className="text-2xl font-black tracking-tighter text-black uppercase mb-3">
                NOT FINDING ANSWERS?
              </h4>
            ...
            {faqs.map((faq, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <h4 className={`text-2xl md:text-4xl lg:text-[40px] font-black tracking-tighter leading-[1.1] uppercase transition-colors ${isOpen ? 'text-black' : 'text-slate-900 group-hover:text-slate-500'}`}>
                      {faq.question}
                    </h4>
                    <div className="ml-4 shrink-0 transition-transform duration-300">
                      {isOpen ? (
                        ...
                        <Plus className="w-8 h-8 text-black group-hover:text-slate-500" />
                      )}
                    </div>
                  </button>
                  <motion.div 
